...
class GoodsReceiptNote(db.Model, UUIDPrimaryKeyMixin, TenantMixin, AuditMixin):
    """PRC-07: records receipt against a PO. Confirmation updates
    Inventory (Module 8) automatically -- via a service call once that
    module exists; this table records the receipt fact regardless."""
